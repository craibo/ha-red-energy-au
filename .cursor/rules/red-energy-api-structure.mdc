...
[
  {
    ...
    "propertyNumber": "82227160.1000001",
    ...
    "address": {
      ...
      "state": "NSW",
      "country": null,
      "gentrackDisplayAddress": "1 EXAMPLE ST, TESTVILLE, NSW 2000",
      "displayAddresses": {
        "shortForm": "1 Example Street, Testville",
        "shortFormAlt": "1 Example Street, Testville",
        "extraShortForm": "1 Example Street",
        "longForm": "1 Example Street\nTestville NSW 2000",
        "longFormAlt": "1 Example Street, Testville, New South Wales 2 0 0 0"
      },
      "displayAddress": "1 EXAMPLE ST\nTESTVILLE  NSW  2000"
    },
    "consumers": [
      {
...
| API Field | Our Internal Field | Transformation |
|-----------|-------------------|----------------|
| `house` + `street` | `street` | Combined: `"1 EXAMPLE ST"` |
...
1. `displayAddresses.shortForm` ✅ **Preferred** - "1 Example Street, Testville"
2. `displayAddresses.extraShortForm` - "1 Example Street"
